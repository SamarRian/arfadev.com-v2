...
function Testimonials({ module }: any) {
  const { metaData, paragraph, client } = module;
  return (
    <Section
      {...metaData}
      ...
      color="primary"
    >
      <div className="relative container px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <blockquote className="text-center lg:mx-auto lg:w-3/5">
          <div className="mt-6 lg:mt-10">
            <p className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium text-gray-800">
              <svg
                className="absolute top-0 start-0 transform -translate-x-8 -translate-y-8 size-16 text-primary/40 sm:h-24 sm:w-24"
                width="16"
                height="13"
                viewBox="0 0 16 13"
                fill="none"
          ...
          <footer className="mt-6">
            <div className="font-semibold text-primary-foreground text-xl sm:text-2xl font-serif lg:mb-2">
              {client.name}
            </div>
