...
export const portableSimple: any = {
  block: {
    ...
    normal: ({ children }: any) => (
      <p className="text-sm md:text-base lg:text-lg text-primary dark:text-secondary font-sans leading-normal lg:my-8">
        {children}
      </p>
    ),
    h1: ({ children }: any) => (
    ...
    h2: ({ children }: any) => (
      <h2 className="font-serif text-3xl lg:text-5xl font-semibold text-primary dark:text-secondary md:my-4 lg:my-8 ">
        {children}
      </h2>
    ),
    h3: ({ children }: any) => (
      <h3 className="font-serif text-2xl lg:text-4xl font-semibold text-primary dark:text-secondary md:my-4 lg:my-8 ">
        {children}
      </h3>
    ),
    h4: ({ children }: any) => (
      <h4 className="font-serif text-xl lg:text-3xl font-semibold text-primary dark:text-secondary md:my-4 lg:my-8 ">
        {children}
      </h4>
    ),
    h5: ({ children }: any) => (
      <h5 className="font-serif text-lg lg:text-2xl font-semibold text-primary dark:text-secondary md:my-4 lg:my-8">
        {children}
      </h5>
    ),
    h6: ({ children }: any) => (
      <h6 className="font-serif text-base lg:text-xl font-semibold text-primary dark:text-secondary md:my-4 lg:my-8 ">
        {children}
      </h6>
    ),
